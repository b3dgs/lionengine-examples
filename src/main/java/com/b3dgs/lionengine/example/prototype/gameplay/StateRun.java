 ...
 */
final class StateRun extends StateHelper<EntityModel>
{
    ...
    public StateRun(EntityModel model, Animation animation)
    {
        ...
        addTransition(StateAttack1.class, () -> isFireOnce(Scene.FIRE1));
    ...
    public void update(double extrp)
    {
        ...
        movement.setDestination(input.getHorizontalDirection() * 2, 0.0);
    }
}
